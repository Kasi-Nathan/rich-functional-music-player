      ...
      <div className="container mt-5">
         <div className="row">
            ...
            <div className="col-md-8">
               <div style={{ backgroundColor: 'green', minHeight: '100vh' }} className="d-flex justify-content-center align-items-center">
                  {currentTrack && (
                     <>
                        {/* <video
                           ...
                           <div className="position-relative">
                              ...
                              <div
                                 ...
                                 style={{
                                    ...
                                    left: '0',
                                    borderWidth: '1px',
                                    borderColor: '#f9fafb', // Tailwind's `gray-50`
                                 }}
                              />
                              ...
                              <div className="d-flex flex-row gap-2">
                                 <BackwardIcon className="w-25 h-25 cursor-pointer" onClick={previousTrack} />
                                 <div onClick={isPlaying ? pauseTrack : playTrack}>
                                    {isPlaying ? (
                                       <PauseCircleIcon className="w-25 h-25 cursor-pointer" />
                                    ) : (
                                       <PlayCircleIcon className="w-25 h-25 cursor-pointer" />
                                    )}
                                 </div>
                                 <ForwardIcon className="w-25 h-25 cursor-pointer" onClick={nextTrack} />
                              </div>
                           </div>
                        </div>
                     </>
