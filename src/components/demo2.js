...
const PlayerV2 = () => {
   ...
   return (
      <div className="container-fluid mt-5 p-0 m-0">
         ...
         <div className="row">
            <div className="col-md-2" style={{ backgroundColor: 'rgb(18, 18, 18)' }}>
            ...
            <div className="col-md-8">
               <div style={{ backgroundColor: 'black', minHeight: '100vh' }} className="d-flex justify-content-center align-items-center">
                  {currentTrack && (
                     <>
                        {/* <video
